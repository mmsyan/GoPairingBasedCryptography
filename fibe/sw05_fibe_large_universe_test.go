...
//	fmt.Println("原始消息:", message.Message)
//
//	userAttributes, err := NewFIBELargeUniverseAttributes([]int64{1, 2, 3, 4, 5, 6, 10000, 20000, 30000, 40000, 60000, 80000, 100000})
//	messageAttributes, err := NewFIBELargeUniverseAttributes([]int64{1, 2, 3, 4, 5, 6, 10000, 20000, 30000, 40000, 50000, 70000, 90000})
//
