...
func NewBinaryAccessTree(value string, left, right *BinaryAccessTree) *BinaryAccessTree {
...
func (t *BinaryAccessTree) VectorPad(counter int) {
...
func GetExamples() ([]*BinaryAccessTree, []string) {
	...
	exampleTrees = append(exampleTrees, NewBinaryAccessTree("or",
		NewBinaryAccessTree("A", nil, nil),
		NewBinaryAccessTree("B", nil, nil)))

	// 1: (A and B)
	booleanFormulas = append(booleanFormulas, "(A and B)")
	exampleTrees = append(exampleTrees, NewBinaryAccessTree("and",
		NewBinaryAccessTree("A", nil, nil),
		NewBinaryAccessTree("B", nil, nil)))
